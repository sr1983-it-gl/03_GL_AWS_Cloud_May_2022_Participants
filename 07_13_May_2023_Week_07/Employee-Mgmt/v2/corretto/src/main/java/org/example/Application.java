...
public class Application extends AbstractHandler
{
    ...
    private static final String EMPLOYEES_HTML = loadPage("/employees.html");
    
    private static String loadPage(String filename) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
        		Application.class.getResourceAsStream(filename)))) {
    ...
    private void handleEmployees(HttpServletRequest request, HttpServletResponse response) throws IOException {
        // Handle HTTP requests here.
        response.getWriter().println(EMPLOYEES_HTML);
    }
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
        ...
        } else if (pathInfo.equalsIgnoreCase("/employees")) {
        	handleEmployees(request, response);
        } else {
